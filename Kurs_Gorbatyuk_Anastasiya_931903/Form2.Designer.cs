namespace Kurs_Gorbatyuk_Anastasiya_931903
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "Суммарная площадь прямоугольников больше площади контейнера. Мы не сможем размест" +
    "ить их в контейнере. Измените параметры прямоугольников";
